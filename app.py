...
def parameters():
    ...
    if age < 18:
        return jsonify(message="Sorry "+ name + " you aren't old enough"), 401
    else:
...
def add_planet():
    ...
    if test:
        ...
        db.session.commit() 
        return jsonify(message='A new planet was added'), 201
...
def update_planet():
    ...
    if planet:
        ...
        db.session.commit()
        return jsonify(message='Planet is updated'), 202
    else:
